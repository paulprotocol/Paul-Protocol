...
/// Paul token
contract PaulToken is ERC20("Paul Governance Token", "PAUL"), Ownable {
    ...
    /// We need mint some Paul in advance
    uint256 public paulInAdvance;
    ...
    /// @notice We need mint some Pauls in advance 
    constructor(address _treasuryWalletAddr, uint256 _paulInAdvance) {
        ...
        paulInAdvance = _paulInAdvance;

        mint(treasuryWalletAddr, paulInAdvance);
    }
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Pauls (not scaled);
